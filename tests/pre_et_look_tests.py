...
if __name__ == "__main__":
    ...
    # folder = os.path.join(base_folder, "test6")
    # adjust_logger(True, folder, "INFO")
    ...
    # folder = os.path.join(base_folder, "test7")
    # adjust_logger(True, folder, "INFO")
    ...
    # folder = os.path.join(base_folder, "test8")
    # adjust_logger(True, folder, "INFO")
    ...
    # folder = os.path.join(base_folder, "test9")
    # adjust_logger(True, folder, "INFO")
    ...
    # folder = os.path.join(base_folder, "test110")
    # adjust_logger(True, folder, "INFO")
