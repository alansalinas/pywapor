...
import pyWAPOR.ETLook.variables as vars
import pyWAPOR.ETLook.constants as c
import watertools
...
def main(input_folder, output_folder, Date):
    ...
    rs_min = np.where(id["land_mask"] == 3, 400, 100)   
    ...
    od["r_canopy_0"] = ETLook.resistance.atmospheric_canopy_resistance(od["lai_eff"], od["stress_rad"], od["stress_vpd"], od["stress_temp"], rs_min, c.rcan_max)
